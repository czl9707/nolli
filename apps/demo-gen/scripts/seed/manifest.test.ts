...
describe("rowsToManifest", () => {
  const rows: BuildingRow[] = [
    { slug: "rolex-learning-center", name: "Rolex Learning Center", city: "Lausanne", cc: "CH", latitude: 46.5197, longitude: 6.5668 },
    { slug: "louvre-lens", name: "Louvre-Lens", city: "Lens", cc: "FR", latitude: 50.4333, longitude: 2.8333 },
  ];
