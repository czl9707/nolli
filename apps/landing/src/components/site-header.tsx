 ...
 * left, nav buttons right; mobile folds the nav into one dropdown.
 * Entrance is self-driven (see .bar css): an ancestor opacity fade would
 * form a backdrop root and kill the card's frost until it ended. */
