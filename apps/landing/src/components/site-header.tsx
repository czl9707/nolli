 ...
 * left, future-app links + app-styled CTA right. Mobile collapses the
 * right side into a menu dropdown. The bar itself never eats map clicks
 * (pointer-events pass-through; interactive children opt back in). Fades
 * out approaching the footer (stage drives the wrapper). */
